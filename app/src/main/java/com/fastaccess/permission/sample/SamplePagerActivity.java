...
public class SamplePagerActivity extends BaseActivity {
    ...
    protected List<PermissionModel> permissions() {
        ...
        model.setExplanationMessage("We need this permission to customize your experience by auto completing your email address");
        ...
        model.setMessage("Cur cedrium resistere?A falsis, armarium fidelis epos.");
        model.setExplanationMessage("We need this permission to access to your location to find nearby restaurants and places you like!");
